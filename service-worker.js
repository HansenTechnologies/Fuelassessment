const CACHE_NAME = 'fuel-assessment-v174';
const APP_SHELL = [
  './',
  './index.html',
  ...
  './assets/icon-128.png',
  './assets/icon-180.png',
  './assets/icon-android-v161-192.png',
  './assets/icon-android-v161-512.png',
  './assets/icon-maskable-v161-192.png',
  './assets/icon-maskable-v161-512.png',
